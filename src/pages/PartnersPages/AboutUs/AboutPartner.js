...
export default function AboutPartner() {
    const AboutPartner_Product_images = [
        { src: "assets/AboutPartner/Rectangle22143.png" },
        { src: "assets/AboutPartner/Rectangle22144.png" },
        { src: "assets/AboutPartner/Rectangle22145.png" },
    ];
    ...
    const AboutPartnerimagesPerSlide = isSmallScreen ? 1 : 3;

    const navigate = useNavigate();
    const handleNavigation = () => {
        window.scrollTo(0,0);
        navigate('/Edit_About_Partner');
    };

    return (
        <>
            <Partner_Navbar />
            <div className="AboutPartner_Page">
                <div className="AboutPartner_ProfileCard">
                    <div className="AboutPartner_ProfileCard_topelement"></div>
                    <div className="AboutPartner_ProfileCard_bottomelement">
                        <div className="AboutPartner_ProfileCard_bottomelement_Profilepic">
                        ...
                        <div className="AboutPartner_ProfileCard_bottomelement_details">
                            <p>
                                ...
                                &nbsp; +91 1234567891 &nbsp; <span>(Verified)</span>
                            </p>
                            <p>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                ...
                                &nbsp; randomemail@gmail.com &nbsp; <span>(Verified)</span>
                            </p>
                            <p>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="AboutPartner_ProfileCard_bottomelement_Socials">
                            <div>
                ...
                <h1>About Us</h1>
                <div className="AboutPartner_Aboutus">
                    <p>
                        ...
                        condimentum ac, vestibulum eu nisl. <br /><br />
                        Morem ipsum dolor sit amet, consectetur adipiscing elit. Nunc
                        vulputate libero et velit interdum, ac aliquet odio mattis. Class
                    ...
                    <div className="AboutPartner_Aboutus_details">
                        <div className="AboutPartner_Aboutus_details_one">
                            <p>Category :</p>
                            <p>Products :</p>
                        ...
                        <div className="AboutPartner_Aboutus_details_two">
                            <p>Musical Instruments</p>
                            <p>Piano, Guitar, Violin, Drum <br></br>
                                Trumpet and Flute. </p>
                            <p>123</p>
                            <p>50</p>
                            <p>3L</p>
                ...
                <Link style={{ textDecoration: "none" }} to="/Edit_About_Partner">
                    <button onClick={handleNavigation}>Edit Details </button>
                </Link>
                <h1>Our Product Images</h1>
                <div className="AboutPartner_ProductImages">
                    <Carousel activeIndex={index} onSelect={handleSelect}>
                        {Array.from({ length: Math.ceil(AboutPartner_Product_images.length / AboutPartnerimagesPerSlide) }).map((_, i) => (
                            <Carousel.Item key={i}>
                                <div className="" style={{ display: "flex" }}>
                                    {AboutPartner_Product_images.slice(i * AboutPartnerimagesPerSlide, i * AboutPartnerimagesPerSlide + AboutPartnerimagesPerSlide).map((image, j) => (
                                        <div className="" key={j} style={{ flex: 1 }}>
                                            <img src={image.src} alt={`Slide ${i * AboutPartnerimagesPerSlide + j + 1}`} />
                                        </div>
                                    ))}
                                </div>
                            </Carousel.Item>
