...
import "./EditAboutPartner.css"
import Partner_Navbar from "../Partner_Navbar";

export default function EditAboutPartner() {
    return (
        <>
            <Partner_Navbar />
            <div className='EditAboutPartner_Page'>
                <h1>Edit Details</h1>
                <div className="EditAboutPartner_ProfileCard">
                    <div className="EditAboutPartner_ProfileCard_topelement"></div>
                    <div className="EditAboutPartner_ProfileCard_bottomelement">
                        <div className="EditAboutPartner_ProfileCard_bottomelement_Profilepic">
                            <div className='Profilepichere'>Profile Picture</div>
                            <p className="p1">Partner Name</p>
                            <p className="p2">Profession</p>
                        </div>
                        <div className="EditAboutPartner_ProfileCard_bottomelement_details">
                            <p>
                                <svg
                        ...
                        <div className="EditAboutPartner_ProfileCard_bottomelement_Socials">
                            <div>
                                <img src="assets/JoinUs/Instagram.png"></img>
                            </div>
                            <div>
                                <img src="assets/JoinUs/Facebook.png"></img>
                            </div>
                            <div>
                                <img src="assets/JoinUs/LinkedIn.png"></img>
                            </div>
                            <div>
                                <img src="assets/JoinUs/Youtube.png"></img>
                            </div>
                            <div>
                                <img src="assets/JoinUs/Globe.png"></img>
                            </div>
                        </div>
                    </div>
                </div>
                <button className='EditAboutPartner_Btn1'>Edit Profile Picture</button>

                <div className='EditAboutPartner_form'>
                    <form>
                        <div className='EditAboutPartner_form_inputfield'>
                            <label>Card Display Name</label>
                            <input type='text' placeholder='Enter the name for card'></input>
                        </div>
                        <div className='EditAboutPartner_form_inputfield'>
                            <label>Conatct Number</label>
                            <input type='tel' placeholder='Enter the contact number'></input>
                        </div>
                        <div className='EditAboutPartner_form_inputfield'>
                        ...
                        <div className='EditAboutPartner_form_inputfield'>
                            ...
                            <textarea placeholder='Enter your state, district, city and pincode'/>
                        </div>
                        <div className='EditAboutPartner_form_inputfield'>
                            <label>About Your Company / Product</label>
                            <textarea   placeholder='Tell us about your company and product'/>
                        </div>
                        <div className='EditAboutPartner_form_inputfield'>
                        ...
                        <div className='EditAboutPartner_form_inputfield'>
                            ...
                            <select>
                                <option selected hidden>Select multiple item </option>
                            </select>
                        </div>
                        <div className='EditAboutPartner_form_inputfield'>
                            <label>Current Revenue</label>
                            <input type='text' placeholder='Enter Revenue'></input>
                        </div>
                        <div className='EditAboutPartner_form_inputfield Productimages'>
                            <label>Product Images</label>
                            <div className='EditAboutPartner_form_inputfield_images'>
                                <div>
                        ...
                        <div className='EditAboutPartner_form_inputfield_socials'>
                            <label><img src='assets/JoinUs/Instagram.png'></img></label>
                            <input type='text' placeholder='Enter instagram profile url'></input>
                        </div>
                        <div className='EditAboutPartner_form_inputfield_socials'>
                            <label><img src='assets/JoinUs/Facebook.png'></img></label>
                            <input type='text' placeholder='Enter facebook profile url'></input>
                        </div>
                        <div className='EditAboutPartner_form_inputfield_socials'>
                            <label><img src='assets/JoinUs/LinkedIn.png'></img></label>
                            <input type='text' placeholder='Enter linkedin profile url'></input>
                        </div>
                        <div className='EditAboutPartner_form_inputfield_socials'>
                            <label><img src='assets/JoinUs/Youtube.png'></img></label>
                            <input type='text' placeholder='Enter youtube channel url'></input>
                        </div>
                        <div className='EditAboutPartner_form_inputfield_socials'>
                            <label><img src='assets/JoinUs/Globe.png'></img></label>
